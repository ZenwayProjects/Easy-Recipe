import "../Css/PossibleRecipesPage/RecipesPagination.css";
...
const [itemsPerPage, setItemsPerPage] = useState(2);
 const generalRecipes = props.generalRecipes;
 const pages = [];
...
for (let i=1; i <= Math.ceil(generalRecipes.length/itemsPerPage); i++){
    pages.push(i);
...
const currentItems = generalRecipes.slice(indexOfFirstItem, indexOfLastItem); 
